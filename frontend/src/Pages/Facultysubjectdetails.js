...
const FacultySubjectdetails = () => {
                        ...
                        <div className='inline'>
                            ...
                            <div className='block1'>
                                ...
                                {/* <Select options={semOptions} placeholder='Select semester' styles={customStyles}
                                    ...
                                    readOnly/> */}
                                    <input type="number" onChange={(e) => { setFacultySubject({ ...facultySubject, semester: e.value }) }} value={facultySubject.semester || ''} />
                            ...
                            <div className='block1'>
                                ...
                                {/* <Select options={subSequenceOptions} placeholder='Select sequence' styles={customStyles}
                                    ...
                                    readOnly /> */}
                                    <input type="number" onChange={(e) => { setFacultySubject({ ...facultySubject, subSequence: e.value }) }} value={facultySubject.subSequence || ''} />
    ...
    parseInt(facultySubject.practicalMarks || 0) + parseInt(facultySubject.termworkMarks || 0)}  />
                            </div>
                        </div>
                        <div className='inline'>
    ...
    parseInt(facultySubject.lectureHours || 0)}  />
                            </div>
                        </div>
                        <div className='inline'>
                            <div className='block1'>
